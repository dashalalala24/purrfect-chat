import signUpModuleTemplate from './SignUpModule.hbs?raw';
...
export default class SignUpModule extends Block {
  ...
  onSignUp(e: Event) {
    ...
    if (
      ...
      navigate('signInPage');
      // } else {
      //   this.children.ErrorLine.setProps({ error: true, ErrorText: 'Please check that the entered data is correct' });
    }
  }

  render(): string {
    return signUpModuleTemplate;
  }
